...
Developed **15+ custom DAX measures** to drive the dashboard's logic, including Time Intelligence for Month-over-Month (MoM) comparisons and KPI tracking against business targets.
...
*   **Operational Risk:** Discovered that **Shorts** have the highest return rate, suggesting a need for quality control or product description adjustments.
...
*   **Executive Dashboard:** View for high-level management.
*   **Customer Insights:** Detailed analysis of demographics and behavior.
*   **Data Model Schema:** Visual representation of the Snowflake architecture.
